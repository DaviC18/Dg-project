        ...
        <div className="w-1/2 max-sm:w-full flex flex-col gap-10 justify-center items-center">
            ...
            <form action="" className="flex flex-col gap-5">
              ...
              <div className="flex justify-between">
                ...
                <input
                  ...
                  name=""
                  id=""
                  className="bg-white rounded-full text-black text-[13px]  px-2.5 py-1 font-medium placeholder:text-xs"
              ...
              <div className="flex justify-center items-center mt-3">
                <button
                  type="button"
                  className="group cursor-pointer border-2 border-white py-2.5 px-7 rounded-full transition-all duration-300 hover:bg-white focus:bg-white"
                >
                  <span
                   ...
                   group-hover:bg-clip-text group-hover:text-transparent group-focus:bg-linear-to-r group-focus:from-blue-500 group-focus:to-[#00d3f2]
                   group-focus:bg-clip-text group-focus:text-transparent"
                  >
                    Enviar
                  </span>
                </button>
          ...
          <div>
            <p className="flex max-md:flex-col text-center gap-1">
              ...
              <Link href="/sing-in">
                <span className="font-medium inline-block hover:underline focus:underline">
                  Entrar
                </span>
              </Link>
            </p>
