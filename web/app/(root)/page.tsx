    ...
    <main className="min-h-screen bg-white text-slate-950 border-blue-500">
      <section className="mx-auto grid w-full max-w-7xl grid-cols-1 items-start justify-center gap-12 px-6 py-10 lg:grid-cols-2 lg:py-10">
        <div className="space-y-5">
          ...
          <div className="space-y-5">
            <h1 className="lg:max-w-xl lg:w-full lg:text-start text-center text-6xl font-semibold leading-tight sm:text-6xl">
              Doctor Genesis
            </h1>

            <p className="lg:max-w-xl lg:w-full lg:text-start text-center font-semibold text-lg leading-7 text-slate-950 sm:text-xl">
              Brings speed to triage without stealing the final
              word from the doctor.
            </p>

            <p className="lg:max-w-xl lg:w-full lg:text-start text-center text-base leading-7 text-black/75 sm:text-lg">
